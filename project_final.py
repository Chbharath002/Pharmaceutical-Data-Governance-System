...
def createdb():
    global mycn
    global mycur
    mycn=sqlct.connect(host="localhost",user="Bharath",password="Bharath@123",database="medi_data")
    if mycn.is_connected():
        print("\tThank you for choosing to shop with Challakonda Medical Store.")
    mycur=mycn.cursor()
...
#-------------THE MAIN MENU---------------------
print("\t\t\tChallakonda Medical Store")
createdb()
while True:
    print("\n\n-------------MAIN MENU--------------------")
